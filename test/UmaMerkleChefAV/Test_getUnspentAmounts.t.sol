...
contract Test_GetUnspentAmounts is RoycoTestBase {
    ...
    function test_GetUnspentAmounts_ActiveCampaign(uint8 _numIncentives, uint32 _campaignLength, uint8 _skipPercentage) public {
        ...
        // Call getUnspentAmounts and verify results
        uint256[] memory unspentAmounts = umaMerkleChefAV.getUnspentAmounts(incentiveCampaignId, initialIncentives);
    ...
    function test_GetUnspentAmounts_UnstartedCampaign(uint8 _numIncentives, uint32 _campaignLength, uint32 _futureOffset) public {
        _numIncentives = uint8(bound(_numIncentives, 1, 10));
    ...
    function test_GetUnspentAmounts_NearEndOfCampaign(uint8 _numIncentives, uint32 _campaignLength, uint8 _remainingPercentage) public {
        _numIncentives = uint8(bound(_numIncentives, 1, 10));
    ...
    function test_GetUnspentAmounts_PartialIncentives(uint8 _numIncentives, uint32 _campaignLength, uint8 _skipPercentage) public {
        ...
        // Call getUnspentAmounts and verify results
        uint256[] memory unspentAmounts = umaMerkleChefAV.getUnspentAmounts(incentiveCampaignId, queryIncentives);
    ...
    function test_GetUnspentAmounts_AfterPartialRemoval(uint8 _numIncentives, uint32 _campaignLength, uint8 _removalPercentage, uint8 _queryPercentage) public {
        _numIncentives = uint8(bound(_numIncentives, 1, 10));
        _campaignLength = uint32(bound(_campaignLength, 7 days, 365 days));
